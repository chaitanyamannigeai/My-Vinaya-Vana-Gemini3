    ...
    <div className="bg-white p-8 rounded-lg shadow max-w-2xl space-y-8">
        ...
        <div>
            ...
            <div className="space-y-4">
                ...
                <div><label className="block text-sm font-medium text-gray-700 flex items-center gap-2"><MapIcon size={16}/> Google Map Embed URL</label><input type="text" value={settings.googleMapUrl || ''} onChange={(e) => setSettings({...settings, googleMapUrl: e.target.value})} className="mt-1 block w-full border p-2 rounded"/></div>
              ...
              <MapContainer center={[20, 0]} zoom={2} style={{ height: '100%', width: '100%' }}>
                  ...
                  {geoData.map((point, idx) => (
                      <CircleMarker 
                          ...
                          radius={Math.min(point.visits * 2 + 3, 20)} 
                          fillColor={point.visits > 10 ? "#ef4444" : "#3b82f6"} 
