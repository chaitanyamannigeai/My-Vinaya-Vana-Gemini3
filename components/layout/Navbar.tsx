      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center">
            ...
            {/* Google Translate Desktop Wrapper */}
            <div className="ml-6 flex items-center">
                <div id="google_translate_element" className="text-nature-200 text-sm"></div>
            </div>
          </div>

          {/* Mobile menu button */}
          <div className="md:hidden flex items-center gap-4">
             {/* Simplified Translate for Mobile Header if needed, mostly handled in drawer */}
            <button
          ...
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            {navLinks.map((link) => (
             ...
             <div className="px-3 py-2">
                <div className="text-xs text-nature-400 mb-1 flex items-center gap-1"><Globe size={12}/> Change Language</div>
